#pragma once
enum Kind {EoF, L_paren, R_paren, Ampr, Vert_bar, Excl, Bool, Int, Plus, Minus, Star, F_slash, B_slash, Percent, Less, Greater, Less_than, Greater_than, Equal, Question, Colon};
